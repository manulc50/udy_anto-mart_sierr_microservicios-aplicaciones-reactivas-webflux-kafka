...
public class ProductoServicioImpl implements ProductoServicio {
	...
	@Override
	public Mono<Producto> actualizarStockProducto(int codProducto, int unidades) {
		return obtenerProductoPorCodigo(codProducto)
				.filter(producto -> producto.getStock() >= unidades)
				.doOnNext(producto -> producto.setStock(producto.getStock() - unidades))
				.flatMap(producto -> productoRepositorio.save(producto));
	}
